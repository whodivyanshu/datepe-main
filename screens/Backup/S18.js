      ...
      <View style={styles.s17FinalProfileSwipeOr}>
        ...
        >
          <View style={styles.matchWrapper}>
            <Text
              style={styles.match}
              onPress={() => navigation.navigate('S19')}
            >
              match
            </Text>
          </View>
        ...
        >
          ...
          {isLoading ? (
            ...
            <>
              <Text style={styles.sarah19}>{userData.name}, {userData.dob}</Text>
              <Text style={styles.iNeedA}>{userData.status}</Text>
              <View style={[styles.rectangleParent, styles.groupItemLayout]}>
                <View style={[styles.groupItem, styles.groupBg]} />
                <Text style={[styles.anime, styles.animeTypo]}>{userData.chip}</Text>
              </View>
              <View style={[styles.rectangleGroup, styles.groupLayout]}>
                <View style={[styles.groupInner, styles.groupLayout]} />
                <Text style={[styles.kdramas, styles.animeTypo]}>{userData.chip1}</Text>
              </View>
